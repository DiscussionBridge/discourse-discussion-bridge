...
class CreateDiscussionBridgeSourceUrlHistories < ActiveRecord::Migration[7.0]
  def change
    create_table :discussion_bridge_source_url_histories do |t|
    ...
    add_index :discussion_bridge_source_url_histories,
              :old_canonical_url_digest,
              name: "idx_db_source_old_url"
    add_index :discussion_bridge_source_url_histories,
              :bridge_record_id,
              name: "idx_db_source_url_history_record"
    add_index :discussion_bridge_source_url_histories,
              :content_binding_id,
              name: "idx_db_source_url_history_binding"
  end
end
