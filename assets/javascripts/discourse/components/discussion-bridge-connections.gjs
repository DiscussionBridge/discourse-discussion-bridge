...
export default class DiscussionBridgeConnections extends Component {
  ...
  @action updateName(event) { this.name = event.target.value; }
  @action updatePlatform(event) { this.platform = event.target.value; }
  @action updateOrigins(event) { this.origins = event.target.value; }
  @action updateLanes(event) { this.lanes = event.target.value; }
  @action updateToDiscourse(event) { this.toDiscourse = event.target.checked; }
  @action updateFromDiscourse(event) { this.fromDiscourse = event.target.checked; }
  ...
  @action cancelEdit() { this.resetForm(); }
